...
<!-- BLOG-POST-LIST:START -->- 🧰 [Build an AI Image Recognition app using Gemini on Agent Platform - bb-ide-genai-001](https://eplus.dev/build-an-ai-image-recognition-app-using-gemini-on-agent-platform-bb-ide-genai-001) - 2026-07-29 
